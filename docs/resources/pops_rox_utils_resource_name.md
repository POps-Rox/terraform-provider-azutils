...
page_title: "pops_rox_utils_resource_name Resource - terraform-provider-pops-rox-utils"
...
The resource pops_rox_utils_resource_name implements a set of methodologies to apply consistent resource naming using Azure NoOps Accelerator.

The pops_rox_utils_resource_name provides more flexibility and will be updated on a regular basis as new Azure services are released.
