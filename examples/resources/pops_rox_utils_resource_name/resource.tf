...
resource "pops_rox_utils_resource_name" "classic_st" {
  name          = "log2"
  resource_type = "azurerm_storage_account"
}

output "caf_name_classic_st" {
  value       = pops_rox_utils_resource_name.classic_st.result
...
resource "pops_rox_utils_resource_name" "multiple_resources" {
  name           = "cogsdemo2"
  resource_type  = "azurerm_cognitive_account"
...
output "multiple_resources" {
  value = pops_rox_utils_resource_name.multiple_resources.results
}

output "multiple_resources_main" {
  value = pops_rox_utils_resource_name.multiple_resources.result
}