...
const (
	// ConventionNoOps applies the Azure NoOps recommended naming convention
	ConventionNoOps string = "noops"
	...
	// ConventionPassThrough defines the Azure NoOps random naming convention
...
// ResourceStructure stores the Prefix and the MaxLength of an azure resource
type ResourceStructure struct {
	...
	NoOpsPrefix string `json:"slug,omitempty"`
